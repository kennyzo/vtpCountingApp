...
input_video = "./input_images_and_videos/bang_chuyen_1.mp4"
...
roi = 900 # roi line position
deviation = 2 # the constant that represents the object counting area

object_counting_api.cumulative_object_counting_y_axis(input_video, detection_graph, category_index, is_color_recognition_enabled, roi, deviation, False) # counting all the objects
